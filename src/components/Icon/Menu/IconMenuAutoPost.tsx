...
interface IconMenuAutoPostProps {
    className?: string;
}

const IconMenuAutoPost: FC<IconMenuAutoPostProps> = ({ className }) => {
    return (

        <svg viewBox="0 0 1124 1124" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path
                opacity="0.6"
...
export default IconMenuAutoPost;
