...
interface IconMenuFollowBackProps {
    className?: string;
    opValor: string;
    width: string;
    height: string;
}
const IconMenuFollowBack: FC<IconMenuFollowBackProps> = ({ className, opValor, width, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 740 512" fill="currentColor">
            <path
                opacity={opValor}
...
export default IconMenuFollowBack;
