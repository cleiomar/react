...
const IconMenuInstaUsers: FC<IconMenuInstaUsersProps> = ({ className }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="256" height="256" fill="none" className={className}>
        <path
        opacity="0.6"
