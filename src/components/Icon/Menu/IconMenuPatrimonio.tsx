...
interface IconMenuPatrimonioProps {
    className?: string;
    opValor: string;
    width: string;
    height: string;
...
const IconMenuPatrimonio: FC<IconMenuPatrimonioProps> = ({ className, opValor, width, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor" viewBox="0 0 94 94" className={className}>
            <path            
            opacity={opValor}
...
export default IconMenuPatrimonio;
