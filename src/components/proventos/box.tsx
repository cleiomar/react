...
function Box({ categoria, categoria_nome, hide, valor_total_patrimonio }: BoxProps) {
            ...
            <div className="border border-[#d3d3d3] rounded dark:border-[#1b2e4b]">
                ...
                <div>
                    <AnimateHeight duration={300} height={active === '1' ? 'auto' : 0}>
                        <div>
                        <div className="grid 1xl:grid-cols-4 lg:grid-cols-4 sm:grid-cols-2 grid-cols-2 gap-6 mb-4">
                            <center><div><div>TOTAL ÚLTIMOS 6 MESES</div><div className='text-md'><b>R$ 186.768,25</b></div></div></center>
                            <center><div><div>TOTAL ÚLTIMOS 12 MESES</div><div className='text-md'><b>R$ 353.633,32</b></div></div></center>
                            <center><div><div>TOTAL ÚLTIMOS 24 MESES</div><div className='text-md'><b>R$ 688.445,27</b></div></div></center>
                            <center><div><div>PROVISIONADO</div><div className='text-md'><b>R$ 17.898,08</b></div></div></center>
                        </div>
                        </div>
                            ...
                            <div className="datatables">
                                <DataTable
                                    ...
                                    columns={[
                                        ...
                                        {
                                            accessor: 'preco_medio', title: 'Quantidade',
