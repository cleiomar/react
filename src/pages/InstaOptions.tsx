    ...
    return (
        ...
        <div className="panel pb-4 bg-primary-light flex justify-between shadow-primary">
            ...
            <label className="w-12 h-6 relative">
                <input type="checkbox" name={id} checked={states[id]} onChange={() => handleCheckboxChange(id)} className="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer" />
